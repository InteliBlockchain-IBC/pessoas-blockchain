...
// Funções puras usadas por StageBlock, ApplicationSummary e (via o barril em
// selection/[id]/_components/helpers.tsx) pela CandidateTable.
...
// Estilo de campo compartilhado por StageBlock e ApplicationSummary — mesmo
// valor que members/[id]/page.tsx já usa (comentário lá: "o componente Input
// nunca chegou nesta página").
export const CAMPO =
